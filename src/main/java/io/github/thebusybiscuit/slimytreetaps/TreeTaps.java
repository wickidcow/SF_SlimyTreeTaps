...
public class TreeTaps extends JavaPlugin implements SlimefunAddon {
	...
	public void onEnable() {
		...
		SlimefunItemStack treeTap = new SlimefunItemStack("TREE_TAP", Material.WOODEN_HOE, "&6树木龙头", getLore("树脂", cfg.getInt("resin-chance.standard")));
		SlimefunItemStack reinforcedTreeTap = new SlimefunItemStack("REINFORCED_TREE_TAP", Material.IRON_HOE, "&6强化树木龙头", getLore("树脂", cfg.getInt("resin-chance.reinforced")));
		SlimefunItemStack diamondTreeTap = new SlimefunItemStack("DIAMOND_TREE_TAP", Material.DIAMOND_HOE, "&b钻石树木龙头", getLore("树脂", cfg.getInt("resin-chance.diamond")));
		SlimefunItemStack treeScraper = new SlimefunItemStack("TREE_SCRAPER", Material.GOLDEN_SHOVEL, "&b树木刮刀", getLore("琥珀", cfg.getInt("amber-chance")));

		clearAttributes(treeTap, reinforcedTreeTap, diamondTreeTap, treeScraper);
		
		SlimefunItemStack stickyResin = new SlimefunItemStack("STICKY_RESIN", Material.BROWN_DYE, "&6黏性树脂", "", "&7可加工成橡胶");
		SlimefunItemStack rubber = new SlimefunItemStack("RUBBER", Material.FIREWORK_STAR, "&e橡胶", "", "&7塑料的替代来源");
		SlimefunItemStack rawPlastic = new SlimefunItemStack("RAW_PLASTIC", Material.PAPER, "&r未加工塑料");
		...
		SlimefunItemStack resinExtractor = new SlimefunItemStack("RESIN_EXTRACTOR", Material.SMITHING_TABLE, "&c树脂提取机", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE), "&8\u21E8 &7速度: 1x", "&8\u21E8 &e\u26A1 &732 J/s");
		SlimefunItemStack resinExtractor2 = new SlimefunItemStack("RESIN_EXTRACTOR_2", Material.SMITHING_TABLE, "&c树脂提取机 &7(&eII&7)", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE), "&8\u21E8 &7速度: 2x", "&8\u21E8 &e\u26A1 &756 J/s");
		
		SlimefunItemStack amber = new SlimefunItemStack("AMBER", "ac7f7b72fc3e733828fcccc0ca8278aca2633aa33a231c93a682d14ac54aa0c4", "&6琥珀", "", "&e由树脂硬化形成的宝石");
		...
		SlimefunItemStack blueEnderPearl = new SlimefunItemStack("BLUE_ENDER_PEARL", "38be8abd66d09a58ce12d377544d726d25cad7e979e8c2481866be94d3b32f", "&9蓝色末影珍珠", "", "&7可用于制作", "&7魔法镜");
		SlimefunItemStack magicalMirror = new SlimefunItemStack("MAGICAL_MIRROR", Material.BLUE_STAINED_GLASS_PANE, "&9魔法镜 &7(未绑定)", "", "&e右键点击 &7将这面镜子", "&7绑定到当前位置。", "", "&7把已绑定的镜子放入", "&7物品展示框，然后点击", "&7展示框即可传送。", "&7每次传送消耗 &b1 颗末影珍珠");
        
		ItemGroup itemGroup = new ItemGroup(new NamespacedKey(this, "tree_taps"), new CustomItemStack(treeTap, "&6粘液树木龙头", "", "&a> 点击打开"));
        ...
        Research treeTapsResearch = new Research(new NamespacedKey(this, "tree_taps"), 6789, "树木龙头", 15);
        ...
        Research magicalMirrorResearch = new Research(new NamespacedKey(this, "magical_mirror"), 6792, "魔法镜", 30);
	...
	public String getBugTrackerURL() {
		return "https://github.com/Slimefun-Reloaded/SlimyTreeTaps/issues";
	}
