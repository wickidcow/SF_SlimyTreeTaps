...
public class TreeTaps extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        SlimefunItemStack treeTap = new SlimefunItemStack(
                "TREE_TAP", Material.WOODEN_HOE, "&6Tree Tap", getLore("resin", cfg.getInt("resin-chance.standard")));
        SlimefunItemStack reinforcedTreeTap = new SlimefunItemStack(
                "REINFORCED_TREE_TAP", Material.IRON_HOE, "&6Reinforced Tree Tap", getLore("resin", cfg.getInt("resin-chance.reinforced")));
        SlimefunItemStack diamondTreeTap = new SlimefunItemStack(
                "DIAMOND_TREE_TAP", Material.DIAMOND_HOE, "&bDiamond Tree Tap", getLore("resin", cfg.getInt("resin-chance.diamond")));
        SlimefunItemStack treeScraper = new SlimefunItemStack(
                "TREE_SCRAPER", Material.GOLDEN_SHOVEL, "&bTree Scraper", getLore("amber", cfg.getInt("amber-chance")));
