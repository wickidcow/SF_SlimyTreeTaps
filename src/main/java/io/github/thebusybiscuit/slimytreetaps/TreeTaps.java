...
public class TreeTaps extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        SlimefunItemStack stickyResin = new SlimefunItemStack(
                "STICKY_RESIN", Material.BROWN_DYE, "&6Sticky Resin", "", "&7Can be turned into Rubber");
        ...
        SlimefunItemStack amber = new SlimefunItemStack(
                "AMBER",
                "ac7f7b72fc3e733828fcccc0ca8278aca2633aa33a231c93a682d14ac54aa0c4",
                "&6Amber",
                "",
                "&eA hardened gem acquired from Resin");
        SlimefunItemStack amberBlock =
                new SlimefunItemStack("AMBER_BLOCK", Material.SHROOMLIGHT, "&6Block of Amber");
        SlimefunItemStack blueEnderPearl = new SlimefunItemStack(
                "BLUE_ENDER_PEARL",
                "38be8abd66d09a58ce12d377544d726d25cad7e979e8c2481866be94d3b32f",
                "&9Blue Ender Pearl",
                "",
                "&7This item can be used to",
                "&7craft Magical Mirrors");
        SlimefunItemStack magicalMirror = new SlimefunItemStack(
                "MAGICAL_MIRROR",
                Material.BLUE_STAINED_GLASS_PANE,
                "&9Magical Mirror &7(Unbound)",
                "",
                "&eRight Click &7to bind this Mirror",
                "&7to your current location.",
                "",
                "&7Place a bound mirror into an",
                "&7Item Frame and then click on",
                "&7that Item Frame to teleport.",
                "&7Teleports cost &b1 Ender Pearl");

        ItemGroup itemGroup = new ItemGroup(
                new NamespacedKey(this, "tree_taps"),
                new CustomItemStack(treeTap, "&6Slimy TreeTaps", "", "&a> Click to open"));
        RecipeType rubberFactoryType =
                new RecipeType(new NamespacedKey(this, "rubber_factory"), rubberFactory);

        ItemStack paleOakResin =
                vanillaResinEnabled ? new ItemStack(Material.RESIN_CLUMP, paleOakOutput) : null;
        ...
        new SlimefunItem(
                        itemGroup,
                        stickyResin,
                        new RecipeType(new NamespacedKey(this, "tree_tap"), treeTap),
                        new ItemStack[] {
                            null, null, null,
        ...
        new RubberFactory(
                    ...
                    public void registerDefaultRecipes() {
                        ...
                        registerRecipe(
                                6,
                                new ItemStack[] {new CustomItemStack(rubber, 2)},
                                new ItemStack[] {rawPlastic});
        ...
        MagicalMirror mirror = new MagicalMirror(
                this,
                itemGroup,
                magicalMirror,
                RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        Research automationResearch =
                new Research(new NamespacedKey(this, "rubber_automation"), 6790, "Automated Rubber", 20);
        ...
        Research magicalMirrorResearch =
                new Research(new NamespacedKey(this, "magical_mirror"), 6792, "Magical Mirror", 30);
